...
public readonly ref struct MultiMetadataPropositionFactory<TModel, TMetadata, TUnderlyingMetadata>(
    ...
    [FluentMethod("WhenTrue")]Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenTrue,
    [FluentMethod("WhenFalse")]Func<TModel, BooleanResultBase<TUnderlyingMetadata>, IEnumerable<TMetadata>> whenFalse)
{
