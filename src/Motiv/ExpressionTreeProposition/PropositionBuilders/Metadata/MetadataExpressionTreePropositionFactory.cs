...
public readonly partial struct MetadataExpressionTreePropositionFactory<TModel, TMetadata, TPredicateResult>(
    ...
    [FluentMethod("WhenTrue", Overloads = typeof(AllConverters))]Func<TModel, BooleanResultBase<string>, TMetadata> whenTrue,
    [FluentMethod("WhenFalse", Overloads = typeof(AllConverters))]Func<TModel, BooleanResultBase<string>, TMetadata> whenFalse)
{
