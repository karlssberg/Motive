    ...
    public async Task Should_merge_generated_when_applied_to_class_constructors_with_two_and_three_parameters()
    {
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                {
                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public static Step_3__Test_Factory<T1> WithValue1<T1>(in T1 value1)
                    {
                        return new Step_3__Test_Factory<T1>(value1);
                    }

                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public static Step_0__Test_Factory WithString1(in string string1)
                    {
                        return new Step_0__Test_Factory(string1);
                    }
                }
                ...
                public struct Step_0__Test_Factory
                {
                    ...
                    public Step_0__Test_Factory(in string string1)
                    {
                        _string1__parameter = string1;
                    }

                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public Step_1__Test_Factory WithString2(in string string2)
                    {
                        return new Step_1__Test_Factory(_string1__parameter, string2);
                    }
                }
                ...
                public struct Step_1__Test_Factory
                {
                    ...
                    public Step_1__Test_Factory(in string string1, in string string2)
                    {
                        _string1__parameter = string1;
                    ...
                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public Step_2__Test_Factory WithString3(in string string3)
                    {
                        return new Step_2__Test_Factory(_string1__parameter, _string2__parameter, string3);
                    }
                }
                ...
                public struct Step_2__Test_Factory
                {
                    ...
                    public Step_2__Test_Factory(in string string1, in string string2, in string string3)
                    {
                        _string1__parameter = string1;
                        _string2__parameter = string2;
                ...
                public struct Step_3__Test_Factory<T1>
                {
                    ...
                    public Step_3__Test_Factory(in T1 value1)
                    {
                        _value1__parameter = value1;
                    }

                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public Step_4__Test_Factory<T1, T2> WithValue2<T2>(in T2 value2)
                    {
                        return new Step_4__Test_Factory<T1, T2>(_value1__parameter, value2);
                    }
                }

                public struct Step_4__Test_Factory<T1, T2>
                {
                    private readonly T1 _value1__parameter;
                    private readonly T2 _value2__parameter;
                    public Step_4__Test_Factory(in T1 value1, in T2 value2)
                    {
                        _value1__parameter = value1;
        ...
        const string expected =
            ...
            namespace Test
            {
                ...
                public struct Step_0__Test_Factory<T1>
                {
                    ...
                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public Step_1__Test_Factory<T1, T2> WithValue3<T2>(in T2 value3)
                    {
                        return new Step_1__Test_Factory<T1, T2>(_value1__parameter, value3);
                    }
                }
                ...
                public struct Step_1__Test_Factory<T1, T2>
                {
                    ...
                    public Step_1__Test_Factory(in T1 value1, in T2 value3)
                    {
                        _value1__parameter = value1;
        ...
        const string expected =
            ...
            namespace Test
            {
                public static partial class Factory
                {
                    ...
                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public static Step_0__Test_Factory<T2> WithValue2<T2>(in T2 value2)
                    {
                        return new Step_0__Test_Factory<T2>(value2);
                    }
                }

                public struct Step_0__Test_Factory<T2>
                {
                    private readonly T2 _value2__parameter;
                    public Step_0__Test_Factory(in T2 value2)
                    {
                        _value2__parameter = value2;
                    }

                    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                    public Step_1__Test_Factory<T2, T1> WithValue1<T1>(in T1 value1)
                    {
                        return new Step_1__Test_Factory<T2, T1>(_value2__parameter, value1);
                    }
                }

                public struct Step_1__Test_Factory<T2, T1>
                {
                    private readonly T2 _value2__parameter;
                    private readonly T1 _value1__parameter;
                    public Step_1__Test_Factory(in T2 value2, in T1 value1)
                    {
                        _value2__parameter = value2;
                        _value1__parameter = value1;
                    }
